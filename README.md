...
```
~/src/test-infra$ docker run --rm -v /home/wwong/src/issue-infra:/home/ubuntu/ -v /var/run/docker.sock:/var/run/docker.sock infrakit/devbundle:latest   infrakit template --var filename=file:///home/ubuntu/imported /home/ubuntu/groups.json
...
```
~/src/test-infra$ docker run --rm -v /home/wwong/src/issue-infra:/home/ubuntu/ -v /var/run/docker.sock:/var/run/docker.sock infrakit/devbundle:latest   infrakit util init --group-id test --start vanilla --var filename=file:///home/ubuntu/imported /home/ubuntu/groups.json
